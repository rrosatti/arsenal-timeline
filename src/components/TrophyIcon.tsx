const LeagueTrophy: React.FC = () => {
  return (
    ...
    >
      ...
      <path
        d="M7 7h3v3c0 2-.5 3-1.5 3.5C7.5 12.5 7 11 7 9V7z"
        fill="#c8a44a"
        opacity="0.7"
      />
      <path
        d="M22 7h3v2c0 2-.5 3.5-1.5 4.5-1-1-1.5-2.5-1.5-4.5V7z"
        fill="#c8a44a"
        opacity="0.7"
      />
      <rect
...
const FACup: React.FC = () => {
  return (
    ...
    >
      ...
      <path
        d="M6 6h4v2c0 3-1 5-2.5 6C6.5 13 6 11 6 9V6z"
        fill="#c8a44a"
        opacity="0.7"
      />
      <path
        d="M22 6h4v3c0 2-.5 4-1.5 5C23 13 22 11 22 8V6z"
        fill="#c8a44a"
        opacity="0.7"
      />
      <rect
...
const LeagueCup: React.FC = () => {
  return (
    ...
    >
      ...
      <path
        d="M8 7h4v1c0 2-.5 4-2 5-1-1-2-3-2-5V7z"
        fill="#c8a44a"
        opacity="0.7"
      />
      <path
        d="M20 7h4v1c0 2-1 4-2 5-1.5-1-2-3-2-5V7z"
        fill="#c8a44a"
        opacity="0.7"
      />
...
const EuropeanCup: React.FC = () => {
  return (
    ...
    >
      ...
      <path
        d="M6 5h6v2c0 3-1.5 6-3.5 7C7 13 6 10 6 7V5z"
        fill="#c8a44a"
        opacity="0.7"
      />
      <path
        d="M20 5h6v2c0 3-1 5.5-2.5 7C22 13 20 10 20 7V5z"
        fill="#c8a44a"
        opacity="0.7"
      />
      <rect
...
const getTrophyTypes = ({ title }: { title: string }): string[] => {
  const t = title.toLowerCase();
  const types: string[] = [];

  if (
    t.includes("double") ||
    t.includes("league title") ||
    t.includes("league championship") ||
    t.includes("invincible")
  )
    types.push("league");
  if (t.includes("double") || t.includes("fa cup")) types.push("fa");
  if (t.includes("league cup")) types.push("league-cup");
...
const trophyComponents: Record<string, React.FC> = {
  league: LeagueTrophy,
  fa: FACup,
...
export const TrophyIcons: React.FC<{ title: string }> = ({ title }) => {
